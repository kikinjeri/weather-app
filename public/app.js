    ...
    try{
        ...
        items.slice(0,4).forEach(a=>{
            ...
            div.innerHTML=`<h3>${a.title}</h3>
                           ...
                           <small>${a.pubDate?new Date(a.pubDate).toLocaleString():'Date unavailable'}</small>`;
...
function openModal(a){
    ...
    $('modal-date').textContent=a.pubDate?new Date(a.pubDate).toLocaleString():'Date unavailable';
